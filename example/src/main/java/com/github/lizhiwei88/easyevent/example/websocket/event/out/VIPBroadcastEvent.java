 ...
 * @author lizhiwei
 **/
public class VIPBroadcastEvent implements OutBoundEvent<WebSocketSession> {

    private String p;

    public VIPBroadcastEvent(String p) {
        this.p = p;
    }
    ...
    public void execute(WebSocketSession client) {
        try {
            client.sendMessage(new TextMessage("=== you are vip. VIPBroadcast"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
